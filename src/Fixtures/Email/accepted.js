...
<html lang="pt-BR">
  ...
  <body style="margin:0; padding:0; font-family: Arial, sans-serif; background-color:#f5f5f5;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 20px 0;">
      <tr>
        <td align="center">
          <table class="container" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 5px rgba(0,0,0,0.1); width: 600px; max-width: 100%;">
            <!-- Header -->
            <tr>
              <td class="header" style="background:linear-gradient(0deg, rgba(42, 123, 155, 1) 0%, rgba(87, 199, 133, 1) 50%, rgba(165, 237, 83, 1) 100%); padding: 20px; color: white; text-align: center; font-size: 24px;">
                Recibo de Pagamento
              </td>
            </tr>
              ...
              <td class="content" style="padding: 30px; color: #333;">
                ...
                <table class="details" width="100%" cellpadding="0" cellspacing="0" style="margin-top: 20px; font-size: 15px;">
                  ...
                  <tr>
                    ...
                    <td style="padding: 5px 0;">R$ 349,90</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td style="padding: 5px 0;">Pago</td>
                  </tr>
                </table>
            ...
            <tr>
              <td class="footer" style="background-color: #eeeeee; padding: 20px; text-align: center; font-size: 13px; color: #666;">
                © 2025 Exemplo S.A. | contato@exemplo.com.br<br/>
