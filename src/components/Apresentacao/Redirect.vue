<template>
    <section class="redirect">
      <div class="redirect-container" ref="redirectContainer">
        ...
        <a class="redirect-anchor">CONTRIBUIR</a>
      </div>
    </section>
  </template>
  ...
  const redirectContainer = ref(null);
  
  onMounted(() => {
    gsap.from(redirectContainer.value, {
      scrollTrigger: {
        trigger: redirectContainer.value,
        start: 'top 90%',
      },
      opacity: 0,
      y: 100,
  ...
  <style scoped>
    ...
    .redirect-anchor{
      ...
      border-radius: 20px;
      padding-inline: clamp(2rem, 20vw, 10rem);
      padding-block: .8rem;
      margin-top: 2rem;
    }

    .redirect-anchor:hover{
      color: #f1f1ed;
      background: #70705b;
    }
  </style>
